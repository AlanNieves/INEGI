...
const Navbar: React.FC = () => {
    ...
    glass-liquid ">
        ...
        border border-blue-400/20 shadow-[0_8px_30px_rgba(0,0,0,0.3)]
        bg-gradient-to-b from-blue-900/90 via-blue-900/70 to-blue-900/40
        backdrop-blur-xl
        animate-slideDown"
                        >
                            <div className="py-2">
                                ...
                                <Link
                                    ...
                                    className="group flex items-center px-4 py-3 gap-3 text-blue-100 
                hover:bg-blue-500/10 transition-all duration-200"
                                >
                                    <svg className="w-5 h-5 text-blue-300 group-hover:scale-110 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
